 ...
 * @author Lenovo
 */
public class modify_seller extends HttpServlet {
...
//            String p=request.getParameter("password");
            ...
            try{
            PreparedStatement ps=obj.c.prepareStatement("update seller set sname=?,email=?,course=?,branch=?,sem=?,hostel=?,roomno=?,contact=? where uid=?");
